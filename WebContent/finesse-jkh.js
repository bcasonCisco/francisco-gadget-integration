...
finesse.clientservices.ClientServices = (function () {
    ...
    return {
        ...
        */
         ...
         */
            makeRequest: function (url, handler, params, useAdmin) {
            ...
            if (useAdmin)
                params[gadgets.io.RequestParameters.HEADERS].Authorization = "Basic " + _config.adminAuthorization;
            else
        ...
        init: function (config) {
            if (!_inited) {
                ...
                // If administrator credentials passed, then save them
                if (_config.adminUsername && _config.adminPassword) {
                    _config.adminAuthorization = _util.b64Encode (_config.adminUsername + ":" + _config.adminPassword);
                }
...
finesse.restservices.RestBase = finesse.FinesseBase.extend({
    ...
    */
    restRequest: function (url, options) {
        ...
        if (typeof options._useAdmin === "boolean")
            finesse.clientservices.ClientServices.makeRequest (encodedUrl, this._createAjaxHandler (options), params, options._useAdmin);
        else
            finesse.clientservices.ClientServices.makeRequest (encodedUrl, this._createAjaxHandler (options), params, false);
    },
            ...
            _objectDeleter = function (object) {
                ...
                newRestObj = new (scope.getRestItemClass())({
                      id: objectId,
                            ...
                            //Normalize and add  REST object to collection datastore.
                            scope._collection[objectId] = newObj;
                            scope._collectionDeleteNotifier.notifyListeners(newObj);
...
/**
 * @fileOverview JavaScript representation of the Finesse ClientLog object
 *
 * @name ClientLog
 * @requires finesse.clientservices.ClientServices
 * @requires Class
...
/** @private */
finesse.restservices.ClientLog = finesse.restservices.RestBase.extend(/** @lends finesse.restservices.ClientLog.prototype */{
    /**
     * @private
     ...
     */
    getRestClass: function () {
        return finesse.restservices.ClientLog;
    },
 ...
 * @fileOverview JavaScript representation of the Finesse Queue object
 * @author <a href="mailto:tchan2@cisco.com">Tony Chan</a>
 * @name finesse.restservices.Queue
 * @requires finesse.clientservices.ClientServices
 * @requires Class
 * @requires finesse.FinesseBase
 * @requires finesse.restservices.RestBase
 ...
 *
 * @constructor
 * @borrows finesse.restservices.RestBase as finesse.restservices.Queue
 */
finesse.restservices.Queue = finesse.restservices.RestBase.extend({

    /**
     * Initialize the Queue object.
     * @param id is the REST id
     * @param callbacks are the callback handlers (onLoad & onError)
     **/
    init: function (options) {
        this._super(options);
    },
...
//     },
     ...
     */
    getRestClass: function () {
        return finesse.restservices.Queue;
    },
...
/**
 * @fileOverview JavaScript representation of the Finesse Queues collection
 ...
 */
finesse.restservices.Queues = finesse.restservices.RestCollectionBase.extend({

    /**
     * Initialize the Queue collection object.
     * @param {Object}
     *     The callback handlers (onLoad, onChange, onError, onDelete, onAdd)
     **/
    init: function (options) {
        this._super(options);
    },
     ...
     */
    getRestClass: function () {
        return finesse.restservices.Queues;
    },
 ...
 * @fileOverview JavaScript representation of the Finesse Contact object.
 *
 * @name finesse.restservices.Contact
 * @requires finesse.clientservices.ClientServices
 * @requires Class
 * @requires finesse.FinesseBase
 * @requires finesse.restservices.RestBase
...
/** @private */
finesse.restservices.Contact = finesse.restservices.RestBase.extend(/** @lends finesse.restservices.Contact.prototype */{
     ...
     *         </ul></li>
     *         <li><b>parentObj: (optional)</b> The parent object</li></ul>
     * @constructs finesse.restservices.Contact
     **/
    init: function (options) {
        this._super(options);
    },
     ...
     */
    getRestClass: function () {
        return finesse.restservices.Contact;
    },
...
/**
* @fileOverview JavaScript representation of the Finesse Contacts collection
* object which contains a list of Contact objects.
 *
 * @name finesse.restservices.Contacts
 * @requires finesse.clientservices.ClientServices
 * @requires Class
 * @requires finesse.FinesseBase
 * @requires finesse.restservices.RestBase
...
/** @private */
finesse.restservices.Contacts = finesse.restservices.RestCollectionBase.extend(/** @lends finesse.restservices.Contacts.prototype */{
     ...
     *         </ul></li>
     *         <li><b>parentObj: (optional)</b> The parent object</li></ul>
     * @constructs finesse.restservices.Contacts
     **/
        init: function (options) {
                this._super(options);
        },
     ...
     * @private
         ...
         */
        getRestClass: function () {
            return finesse.restservices.Contacts;
        },
 ...
 * @fileOverview JavaScript representation of the Finesse PhoneBook object.
 *
 * @name finesse.restservices.PhoneBook
 * @requires finesse.clientservices.ClientServices
 * @requires Class
 * @requires finesse.FinesseBase
 * @requires finesse.restservices.RestBase
...
/** @private */
finesse.restservices.PhoneBook = finesse.restservices.RestBase.extend(/** @lends finesse.restservices.PhoneBook.prototype */{
     ...
     *         </ul></li>
     *         <li><b>parentObj: (optional)</b> The parent object</li></ul>
     * @constructs finesse.restservices.PhoneBook
     **/
    init: function (options) {
        this._super(options);
    },
     ...
     */
    getRestClass: function () {
        return finesse.restservices.PhoneBook;
    },
    ...
    getContacts: function (callbacks) {
        ...
        if ((this._contacts === null) || (this._contacts === undefined)) {
            this._contacts = new finesse.restservices.Contacts(options);
        }
...
/**
* @fileOverview JavaScript representation of the Finesse PhoneBooks collection
* object which contains a list of PhoneBook objects.
 *
 * @name finesse.restservices.PhoneBooks
 * @requires finesse.clientservices.ClientServices
 * @requires Class
 * @requires finesse.FinesseBase
 * @requires finesse.restservices.RestBase
...
/** @private */
finesse.restservices.PhoneBooks = finesse.restservices.RestCollectionBase.extend(/** @lends finesse.restservices.PhoneBooks.prototype */{

    /**
     * @class
     * JavaScript representation of a PhoneBooks collection object. Also exposes
     * methods to operate on the object against the server.
     *
         * @param {Object} options
         *     An object with the following properties:<ul>
     ...
     *         </ul></li>
     *         <li><b>parentObj: (optional)</b> The parent object</li></ul>
     * @constructs finesse.restservices.PhoneBooks
     **/
        init: function (options) {
                this._super(options);
        },
     ...
     * @private
         ...
         */
        getRestClass: function () {
            return finesse.restservices.PhoneBooks;
        },
...
finesse.restservices.User = finesse.restservices.RestBase.extend(/** @lends finesse.restservices.User.prototype */{
    ...
    * @private
    ...
    getDialogs: function (callbacks) {
        ...
        if ((this._dialogs === null) || (this._dialogs === undefined)) {
    ...
    getClientLog: function (callbacks) {
        ...
        if ((this._clientLogObj === null) || (this._clientLogObj === undefined)) {
    ...
    getQueues: function (callbacks) {
        ...
        if ((this._queues === null) || (this._queues === undefined)) {
            this._queues = new finesse.restservices.Queues(options);
        }
    ...
    getWrapUpReasons: function (callbacks) {
        ...
        if ((this._wrapUpReasons === null) || (this._wrapUpReasons === undefined)) {
    ...
    getPhoneBooks: function (callbacks) {
        ...
        if ((this._phoneBooks === null) || (this._phoneBooks === undefined)) {
    ...
    getMediaPropertiesLayout: function (callbacks) {
        ...
        this.isLoaded();
        if ((this._mediaPropertiesLayout === null) || (this._mediaPropertiesLayout === undefined)) {
 ...
 * @fileOverview JavaScript representation of the Finesse Team Not Ready Reason Code Assignment object.
 *
 * @name finesse.restservices.TeamNotReadyReasonCode
 * @requires finesse.clientservices.ClientServices
 * @requires Class
 * @requires finesse.FinesseBase
 * @requires finesse.restservices.RestBase
...
/** @private */
finesse.restservices.TeamNotReadyReasonCode = finesse.restservices.RestBase.extend(/** @lends finesse.restservices.TeamNotReadyReasonCode.prototype */{
     ...
     *         </ul></li>
     *         <li><b>parentObj: (optional)</b> The parent object</li></ul>
     * @constructs finesse.restservices.TeamNotReadyReasonCode
     **/
    init: function (options) {
        this._super(options);
    },
     ...
     */
    getRestClass: function () {
        return finesse.restservices.TeamNotReadyReasonCode;
    },
...
/**
* @fileOverview JavaScript representation of the Finesse TeamNotReadyReasonCodes collection
* object which contains a list of TeamNotReadyReasonCode objects.
 *
 * @name finesse.restservices.TeamNotReadyReasonCodes
 * @requires finesse.clientservices.ClientServices
 * @requires Class
 * @requires finesse.FinesseBase
 * @requires finesse.restservices.RestBase
...
/** @private */
finesse.restservices.TeamNotReadyReasonCodes = finesse.restservices.RestCollectionBase.extend(/** @lends finesse.restservices.TeamNotReadyReasonCodes.prototype */{
     ...
     *         </ul></li>
     *         <li><b>parentObj: (optional)</b> The parent object</li></ul>
     * @constructs finesse.restservices.TeamNotReadyReasonCodes
     **/
    init: function (options) {
        this._super(options);
    },
     ...
     */
    getRestClass: function () {
        return finesse.restservices.TeamNotReadyReasonCodes;
    },
     ...
     *
     * @returns {finesse.restservices.TeamNotReadyReasonCodes}
 ...
 * @fileOverview JavaScript representation of the Finesse Team Wrap Up Reason object.
 *
 * @name finesse.restservices.TeamWrapUpReason
 * @requires finesse.clientservices.ClientServices
 * @requires Class
 * @requires finesse.FinesseBase
 * @requires finesse.restservices.RestBase
...
/** @private */
finesse.restservices.TeamWrapUpReason = finesse.restservices.RestBase.extend(/** @lends finesse.restservices.TeamWrapUpReason.prototype */{
     ...
     *         </ul></li>
     *         <li><b>parentObj: (optional)</b> The parent object</li></ul>
     * @constructs finesse.restservices.TeamWrapUpReason
     **/
    init: function (options) {
        this._super(options);
    },
     ...
     */
    getRestClass: function () {
        return finesse.restservices.TeamWrapUpReason;
    },
...
/**
* @fileOverview JavaScript representation of the Finesse Team Wrap-Up Reasons collection
* object which contains a list of Wrap-Up Reasons objects.
 *
 * @name finesse.restservices.TeamWrapUpReasons
 * @requires finesse.clientservices.ClientServices
 * @requires Class
 * @requires finesse.FinesseBase
 * @requires finesse.restservices.RestBase
...
/** @private */
finesse.restservices.TeamWrapUpReasons = finesse.restservices.RestCollectionBase.extend(/** @lends finesse.restservices.TeamWrapUpReasons.prototype */{
     ...
     *         </ul></li>
     *         <li><b>parentObj: (optional)</b> The parent object</li></ul>
     * @constructs finesse.restservices.TeamWrapUpReasons
     **/
    init: function (options) {
        this._super(options);
    },
     ...
     */
    getRestClass: function () {
        return finesse.restservices.TeamWrapUpReasons;
    },
 ...
 * @fileOverview JavaScript representation of a TeamSignOutReasonCode.
 *
 * @name finesse.restservices.TeamSignOutReasonCode
 * @requires finesse.clientservices.ClientServices
 * @requires Class
 * @requires finesse.FinesseBase
 * @requires finesse.restservices.RestBase
...
/** @private */
finesse.restservices.TeamSignOutReasonCode = finesse.restservices.RestBase.extend(/** @lends finesse.restservices.TeamSignOutReasonCode.prototype */{
     ...
     *         </ul></li>
     *         <li><b>parentObj: (optional)</b> The parent object</li></ul>
     * @constructs finesse.restservices.TeamSignOutReasonCode
     **/
    init: function (options) {
        this._super(options);
    },
     ...
     */
    getRestClass: function () {
        return finesse.restservices.TeamSignOutReasonCode;
    },
...
/**
* @fileOverview JavaScript representation of the TeamSignOutReasonCodes collection
* object which contains a list of TeamSignOutReasonCode objects.
 *
 * @name finesse.restservices.TeamSignOutReasonCodes
 * @requires finesse.clientservices.ClientServices
 * @requires Class
 * @requires finesse.FinesseBase
 * @requires finesse.restservices.RestBase
...
/** @private */
finesse.restservices.TeamSignOutReasonCodes = finesse.restservices.RestCollectionBase.extend({/** @lends finesse.restservices.TeamSignOutReasonCodes.prototype */
    /**
     * @class
     ...
     *         </ul></li>
     *         <li><b>parentObj: (optional)</b> The parent object</li></ul>
     * @constructs finesse.restservices.TeamSignOutReasonCodes
     **/
    init: function (options) {
        this._super(options);
    },
     ...
     */
    getRestClass: function () {
        return finesse.restservices.TeamSignOutReasonCodes;
    },
...
/**
 * @fileOverview JavaScript representation of the Finesse PhoneBook Assignment object.
 *
 * @name finesse.restservices.TeamPhoneBook
 * @requires finesse.clientservices.ClientServices
 * @requires Class
 * @requires finesse.FinesseBase
 * @requires finesse.restservices.RestBase
...
/** @private */
finesse.restservices.TeamPhoneBook = finesse.restservices.RestBase.extend(/** @lends finesse.restservices.TeamPhoneBook.prototype */{
     ...
     *         </ul></li>
     *         <li><b>parentObj: (optional)</b> The parent object</li></ul>
     * @constructs finesse.restservices.TeamPhoneBook
     **/
    init: function (options) {
        this._super(options);
    },
     ...
     */
    getRestClass: function () {
        return finesse.restservices.TeamPhoneBook;
    },
...
/**
* @fileOverview JavaScript representation of the Finesse PhoneBook Assignments collection
* object which contains a list of Not Ready Reason Codes objects.
 *
 * @name finesse.restservices.TeamPhoneBooks
 * @requires finesse.clientservices.ClientServices
 * @requires Class
 * @requires finesse.FinesseBase
 * @requires finesse.restservices.RestBase
...
/** @private */
finesse.restservices.TeamPhoneBooks = finesse.restservices.RestCollectionBase.extend(/** @lends finesse.restservices.TeamPhoneBooks.prototype */{
     ...
     *         </ul></li>
     *         <li><b>parentObj: (optional)</b> The parent object</li></ul>
     * @constructs finesse.restservices.TeamPhoneBooks
     **/
        init: function (options) {
                this._super(options);
        },
     ...
     * @private
         ...
         */
        getRestClass: function () {
            return finesse.restservices.TeamPhoneBooks;
        },
 ...
 * @fileOverview JavaScript representation of the Finesse LayoutConfig object.
 *
 * @name finesse.restservices.LayoutConfig
 * @requires finesse.clientservices.ClientServices
 * @requires Class
 * @requires finesse.FinesseBase
 * @requires finesse.restservices.RestBase
...
/** @private */
finesse.restservices.TeamLayoutConfig = finesse.restservices.RestBase.extend(/** @lends finesse.restservices.LayoutConfig.prototype */{
     ...
     *         </ul></li>
     *         <li><b>parentObj: (optional)</b> The parent object</li></ul>
     * @constructs finesse.restservices.LayoutConfig
     **/
    init: function (options) {
        this._super(options);
    },
     ...
     */
    getRestClass: function () {
        return finesse.restservices.LayoutConfig;
    },
    ...
    getLayoutXML: function () {
        this.isLoaded();
        var restResponse = this.getRestResponse(),
            domxml = jQuery.parseXML(restResponse),
            layoutxml = $(domxml).find("finesseLayout")[0];
        // get xml string differently depending on browser type
        // XMLSerializer is not present in IE
        return (typeof window.XMLSerializer !== "undefined") ?
            (new window.XMLSerializer()).serializeToString(layoutxml) :
            layoutxml.xml;
    },
...
finesse.restservices.Team = finesse.restservices.RestBase.extend(/** @lends finesse.restservices.Team.prototype */{
    ...
    getTeamLayoutConfig: function (callbacks) {
        ...
        if ((this._teamLayoutConfig === null) || (this._teamLayoutConfig === undefined)) {
...
/**
 * @fileOverview JavaScript representation of the Finesse Teams collection.
 * object which contains a list of Team objects
 * @name finesse.restservices.Teams
 * @requires finesse.clientservices.ClientServices
 * @requires Class
 * @requires finesse.FinesseBase
 * @requires finesse.restservices.RestBase
...
/** @private */
finesse.restservices.Teams = finesse.restservices.RestCollectionBase.extend(/** @lends finesse.restservices.Teams.prototype */{
     ...
     *         </ul></li>
     *         <li><b>parentObj: (optional)</b> The parent object</li></ul>
     * @constructs finesse.restservices.Teams
     **/
    init: function (options) {
        this._super(options);
    },
     ...
     */
    getRestClass: function () {
        return finesse.restservices.Teams;
    },
...
/**
 * @fileOverview JavaScript representation of the Finesse SystemInfo object
 *
 * @name SystemInfo
 * @requires finesse.clientservices.ClientServices
 * @requires Class
...
/** @private */
finesse.restservices.SystemInfo = finesse.restservices.RestBase.extend(/** @lends finesse.restservices.SystemInfo.prototype */{
     ...
     */
    getRestClass: function () {
        return finesse.restservices.SystemInfo;
    },
    ...
    /**
     * Returns the status coresponding to this SystemInfo object:
     ...
     * @returns {String} The xmpp domain coresponding to this SystemInfo object
     */
     ...
     * @returns {String} The xmpp pubsub domain coresponding to this SystemInfo object:
     */
...
finesse.cslogger.ClientLogger = (function () {
    ...
    */
    writeToLogOutput = function (msg) {
        ...
        if ((logOutput === null) || (logOutput === undefined))
        {
