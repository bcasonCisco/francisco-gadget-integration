...
<ModulePrefs title = "Live Assist"
        scrolling = "true"
        description = "Live Assist"
        height = "50"
...
<![CDATA[
    <!------------------------------------------------------------------------------------------------------->
    <!--     The following needs to be imported into the Finesse console as the HTML for the LA Widget     -->
    <!------------------------------------------------------------------------------------------------------->
    ...
    <script type="text/javascript" src="LiveAssist.js"></script>

    <body>
        <div id="iframe-div" style="overflow-x: hidden;overflow-y: hidden">
        </div>
        ...
        <div id="test-div">
            ...
            <input type="text" id="correlation-id" />
        </div>
 ...
 <span id="client-error" style="color:red">  
    ...
    <script type="text/javascript">
        gadgets.HubSettings.onConnect = function () {
            try {
                finesse.modules.LiveAssist.init ();
            }
            catch (ex) {
